...
const REQUIRED_BANK_CRAFTING_METHODS = Object.freeze([
  "stopRoutine",
  "getKnownRecipes",
  "getCraftableRecipes",
...
const validateBankCraftingService = (service) => {
  ...
  throw new TypeError(
    "Merchant-role bank crafting contract violation: expected methods stopRoutine(), getKnownRecipes(), getCraftableRecipes(), and getConfiguredRecipeTargets()",
  );
};
