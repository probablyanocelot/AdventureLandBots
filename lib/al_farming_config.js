      ...
      if (character.name === leader && needsMonsterhuntTurnIn()) {
        ...
        if (
          ...
          if (!requirePriestAggro || priestHolding) {
            ...
            if (npcPortOk) {
              const prewarmedHuntMage = await ensureChainMageRunning({
                cfg,
                mageName: huntMageName,
                chainCfg,
                preferredSubOut: [selectedNpcMage],
                excludeSubOutNames: [chainWarriorName, chainPriestName],
                label: "hunt-chain-hunt-mage-prewarm",
              });

              const selectedHuntMage = prewarmedHuntMage.ok
                ? huntMageName
                : cfg.mageName || huntMageName;
              ...
              logOnce(
                ...
                "hunt-chain started: warrior requested NPC mage port",
                {
                  ...
                  huntMageReady: prewarmedHuntMage.ok,
                  warriorName,
                },
                2000,
              );
