...
const normalizeConfig = (cfgInput) => {
  ...
  const farmingConfig = cfg.farming || cfg.noEventFarming || {};
  cfg.noEventFarming = deepMerge(DEFAULT_CONFIG.noEventFarming, farmingConfig);
  cfg.farming = cfg.noEventFarming;
  ...
  cfg.noEventFarming.highestLuckRangerCrabHold =
    cfg.noEventFarming.highestLuckRangerCrabHold !== false;
  cfg.noEventFarming.highestLuckRangerRareMobRadius = Math.max(
    1,
    Number(
      cfg.noEventFarming.highestLuckRangerRareMobRadius ||
        DEFAULT_CONFIG.noEventFarming.highestLuckRangerRareMobRadius,
    ),
  );
  cfg.noEventFarming.highestLuckRangerEggLuckThresholdMs = Math.max(
    0,
    Number(
      cfg.noEventFarming.highestLuckRangerEggLuckThresholdMs ||
        DEFAULT_CONFIG.noEventFarming.highestLuckRangerEggLuckThresholdMs,
    ),
  );
