...
const DEFAULT_CONFIG = Object.freeze({
  ...
  farming: {
    enabled: true,
    // farmer config can be tuned for fine-grained behavior.
    ...
    highestLuckRangerEggLuckThresholdMs: 2 * 3600 * 1000,
    manualFarmMob: null,
    huntMapDenyByTarget: {
      mummy: ["spookytown"],
      cgoo: ["arena"],
    ...
    huntSpotsByTarget: {
      ...
      prat: [{ map: "level1", x: -88, y: 15 }],
    },
    mvampireCheckIntervalMs: 5 * 60 * 1000,
    mvampireSweepPadPx: 20,
    weakMaxHp: 10000,
    weakMaxAttack: 350,
    highAttack: 600,
    highHp: 30000,
