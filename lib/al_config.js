...
const DEFAULT_CONFIG = Object.freeze({
  ...
  noEventFarming: {
    ...
    // Follower-side assignment TTL before considering it stale.
    assignmentTtlMs: 12000,
    // Allow non-leaders to keep farming while leader turns in/gets a new task.
    continueWhileLeaderBusyMs: 45000,
