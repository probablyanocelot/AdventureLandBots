// Movement request manager.
// Purpose: serialize/throttle smart-move requests with key+destination cooldowns.
// Inputs: destination requests (`dest`, `key`, `priority`, `cooldownMs`).
// Side effects: calls `smart_move` and tracks active/requested paths.
// Safety: suppresses duplicate/low-priority requests and avoids moving while gathering.
