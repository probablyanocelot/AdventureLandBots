const { Idle } = await require("../services/state/index.js");
...
const createRecurringLoop = ({ intervalMs = 1000, onTick } = {}) => {
  // This function creates a recurring loop that calls the onTick function at specified intervals (intervalMs). It returns an object with start, stopRoutine, and dispose methods to control the loop.
  const st = {
    started: false,
    stopped: false,
    timer: null,
