...
const { filterObjectsByProperty } = await require("../domains/shared/index.js");
const { installMagiportAutoAccept } = await require("../domains/cm/index.js");
...
class BotCharacter {
  ...
  async init() {
    ...
    try {
      this._telemetry = createTelemetryService({ cfg });
    } catch (e) {
