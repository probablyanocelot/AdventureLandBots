/******/ (() => {
  ...
  /******/ "use strict";
  /******/ const bank_data =
    /******/ typeof require === "function" ? require("./bank_data.js") : null;
  /******/ const bank_render =
    /******/ typeof require === "function" ? require("./bank_render.js") : null;
  /******/ const bank_actions =
    /******/ typeof require === "function"
      ? require("./bank_actions.js")
      : null;
      ...
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        class EnhancedBankUI {
          ...
          onDragStartBankSlot(e, packName, index) {
            if (bank_actions) {
              return bank_actions.onDragStartBankSlot(this, e, packName, index);
            }
            if (!this.slotMoveMode) {
              return;
            }
          ...
          onDropBankSlot(e, packName, index) {
            if (bank_actions) {
              return bank_actions.onDropBankSlot(this, e, packName, index);
            }
          ...
          getFirstEmptyInventorySlot() {
            return bank_data
              ? bank_data.getFirstEmptyInventorySlot()
              : (() => {
          ...
          parseSearchQuery(search) {
            return bank_data
              ? bank_data.parseSearchQuery(search)
              : (() => {
          ...
          itemMatchesPropertyFilter(itemInfo, propertyFilter) {
            return bank_data
              ? bank_data.itemMatchesPropertyFilter(itemInfo, propertyFilter)
              : (() => {
                  if (!propertyFilter) {
                    return true;
                  }
                  ...
                  if (propertyFilter === "any") {
                    ...
                    if (typeof itemInfo.p === "string") {
                      return (
                        itemInfo.p !== "shiny" && itemInfo.p !== "glitched"
                      );
                    }
          ...
          groupedItemMatchesPropertyFilter(groupedItem, propertyFilter) {
            return bank_data
              ? bank_data.groupedItemMatchesPropertyFilter(
                  this,
                  groupedItem,
                  propertyFilter,
                )
              : (() => {
                  ...
                  for (const levelKey in groupedItem.levels) {
                    ...
                    for (const [packName, index] of levelData.indexes) {
                      ...
                      if (
                        this.itemMatchesPropertyFilter(itemInfo, propertyFilter)
                      ) {
                        return true;
                      }
                    }
          ...
          doesItemMatchSearch(itemInfo, searchQuery) {
            return bank_data
              ? bank_data.doesItemMatchSearch(this, itemInfo, searchQuery)
              : (() => {
                  const query =
                  ...
                  if (
                    !this.itemMatchesPropertyFilter(
                      itemInfo,
                      query.property || "",
                    )
                  ) {
          ...
          onMouseDownBankSlotItem(e, packName, index, itemInfo) {
            if (bank_actions) {
              return bank_actions.onMouseDownBankSlotItem(
                this,
                e,
                packName,
                index,
          ...
          onMouseDownBankSlotEmpty(e, packName, index) {
            if (bank_actions) {
              return bank_actions.onMouseDownBankSlotEmpty(
                this,
                e,
                packName,
                index,
          ...
          getSortedItemKeys(itemsByType) {
            return bank_data
              ? bank_data.getSortedItemKeys(this, itemsByType)
              : Object.keys((itemsByType && itemsByType.items) || {}).sort(
                  (a, b) => a.localeCompare(b),
                );
          }
          getSortedGroupKeys(groups) {
            return bank_data
              ? bank_data.getSortedGroupKeys(this, groups)
              : Object.keys(groups).sort((a, b) =>
                  a.localeCompare(b, undefined, { sensitive: "base" }),
                );
          }
          getDisplayGroupLabel(groupKey) {
            return bank_data
              ? bank_data.getDisplayGroupLabel(this, groupKey)
              : groupKey;
          }
          getGroupLabelForItem(gItem, packName = "") {
            return bank_data
              ? bank_data.getGroupLabelForItem(this, gItem, packName)
              : types[gItem.type] || "Others";
          }
          getBankSource() {
            return bank_data
              ? bank_data.getBankSource(this)
              : (() => {
                  if (character.bank) {
          ...
          captureBankSnapshot() {
            if (bank_data) {
              return bank_data.captureBankSnapshot(this);
            }
            if (!character.bank) {
              return;
            }
          ...
          retrieveFromBank(packName, index, inventoryIndex = -1) {
            return __awaiter(this, void 0, void 0, function* () {
              if (bank_data) {
                return bank_data.retrieveFromBank(
                  packName,
                  index,
                  inventoryIndex,
                );
          ...
          getRetrieveInventorySlot(itemInfo) {
            return bank_data
              ? bank_data.getRetrieveInventorySlot(itemInfo)
              : (() => {
                  if (
                    !itemInfo ||
                    !itemInfo.name ||
          ...
          onMouseDownTellerItem(e, packName, index, itemInfo) {
            if (bank_actions) {
              return bank_actions.onMouseDownTellerItem(
                this,
                e,
                packName,
                index,
          ...
          getPackLabel(packName) {
            return bank_data ? bank_data.getPackLabel(packName) : packName;
          }
          getPackMeta(packName) {
            return bank_data
              ? bank_data.getPackMeta(packName)
              : (() => {
                  if (
                    typeof bank_packs === "undefined" ||
                    !bank_packs[packName]
                  ) {
                    return null;
                  }
          ...
          getSortedKnownPackNames(bank) {
            return bank_data
              ? bank_data.getSortedKnownPackNames(bank)
              : (() => {
          ...
          isPackUnlocked(packName, bank) {
            return bank_data
              ? bank_data.isPackUnlocked(packName, bank)
              : !!(bank && Array.isArray(bank[packName]));
          }
          getPackStatusLabel(packName, bank, usingCachedBank = false) {
            return bank_data
              ? bank_data.getPackStatusLabel(
                  this,
                  packName,
                  bank,
                  usingCachedBank,
          ...
          renderActivePage(bankItemsContainer, tellerItemsContainer) {
            if (bank_render) {
              return bank_render.renderActivePage(
                this,
                bankItemsContainer,
          ...
          renderTellerItems(tellerItemsContainer) {
            if (bank_render) {
              return bank_render.renderTellerItems(this, tellerItemsContainer);
            }
            let _a;
            const $ = parent.$;
            tellerItemsContainer =
          ...
          filter(search) {
            if (bank_data) {
              return bank_data.filter(this, search);
            }
            const result = {};
          ...
          groupBankByItem() {
            return bank_data
              ? bank_data.groupBankByItem(this)
              : (() => {
                  let _a, _b;
                  ...
                  for (const packName in bank) {
                    ...
                    totalBankSlots +=
                      (_a = packItems.length) !== null && _a !== void 0
                        ? _a
                        : 0;
                    for (let index = 0; index < packItems.length; index++) {
                      ...
                      const gItem = G.items[itemInfo.name] || {};
                      const level =
                        (_b = itemInfo.level) !== null && _b !== void 0
                          ? _b
                          : 0;
                      const groupLabel = this.getGroupLabelForItem(
                        gItem,
                        packName,
                      );
                      ...
                      if (!levels) {
                        ...
                        if (itemInfo.p === "glitched") {
                          levels.glitchedCount =
                            (levels.glitchedCount || 0) + 1;
                        }
                      }
                      totalUsedBankSlots++;
                    }
          ...
          onMouseDownBankItem(e, itemKey, level) {
            if (bank_actions) {
              return bank_actions.onMouseDownBankItem(this, e, itemKey, level);
            }
            return __awaiter(this, void 0, void 0, function* () {
              e.preventDefault();
              switch (e.which) {
          ...
          renderBankItems(search = "", bankItemsContainer) {
            if (bank_render) {
              return bank_render.renderBankItems(
                this,
                search,
                bankItemsContainer,
              );
          ...
          renderBankItemsBySlots(search = "", bankItemsContainer) {
            if (bank_render) {
              return bank_render.renderBankItemsBySlots(
                this,
                search,
                bankItemsContainer,
              );
          ...
          renderAllBankSlots(search = "", bankItemsContainer) {
            if (bank_render) {
              return bank_render.renderAllBankSlots(
                this,
                search,
                bankItemsContainer,
              );
