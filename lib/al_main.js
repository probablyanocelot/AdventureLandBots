// Runtime entrypoint.
// Purpose: start/restart the current character runtime and expose live handles.
// Inputs: global Adventure Land runtime context (`character`, game globals).
// Side effects: boots modules/character loop via `bootCharacterRuntime`.
// Exports: `main()` and live getters for `bot`, `orchestrator`, `runtimeScope`, ctors.
