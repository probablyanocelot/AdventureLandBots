// Bot presence broadcaster.
// Purpose: broadcast `bot:code_loaded` to active friendly characters.
// Inputs: active roster from party domain + live character location/state.
// Side effects: sends CM messages to peers.
